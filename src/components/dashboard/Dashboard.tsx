  ...
  return (
    ...
    <div className="block md:hidden fixed inset-0 bg-gray-900 flex items-center justify-center z-50 p-4">
      <div className="bg-gray-800 rounded-lg p-6 text-center max-w-sm">
        ...
        <p className="text-gray-300">Please access this application from a computer for the best experience. Minimum width required: 700px.</p>
      </div>
    </div>
              ...
              <Card className="bg-gray-800 border-purple-500/20">
                <CardHeader>
                  <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                    <h2 className="text-xl sm:text-2xl font-semibold text-purple-400 mb-0">Training Process</h2>
                    <button
                ...
                <CardHeader>
                  <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                    <div className="w-full sm:w-auto">
                      <CardTitle className="text-xl sm:text-2xl text-purple-400">Metrics Dashboard</CardTitle>
                    </div>
